...
public class MainActivityBakResponseString extends BaseActivity {
    ...
    protected void onResume() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(FlickrServiceBakResponseAsString.FLICKR_BASE_URL)
                .addCallAdapterFactory(RxJavaCallAdapterFactory.create())
                .build();

        FlickrServiceBakResponseAsString flickrService = retrofit.create(FlickrServiceBakResponseAsString.class);
...
//                    viewAdapter = new FlickrRecyclerViewAdapter(photos, MainActivityBakResponseString.this);
